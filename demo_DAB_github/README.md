...
The 'demo_DAB_github' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] demo_DAB_github_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/demo_DAB_github.job.yml). The schedule
